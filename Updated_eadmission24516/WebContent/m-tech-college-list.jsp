...
// 	    	Public Private Partnership
	    ...
	    if(pageCount==null)
	    	 list=ac.getCollegeList(currentPageNumber,"mtech",filterFacility,filterStream,filterCourse,filterState,filterOwnership,sorting,requestedURL.trim());
	    else{
	        list=ac.getCollegeList(Integer.parseInt(pageCount)*10,"mtech",filterFacility,filterStream,filterCourse,filterOwnership,filterState,sorting,requestedURL.trim());
...
<body>
	<header class="header-section">
	    ...
	    <div class="row row-gap-md b-tech-header">
	        <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 row-gap-lg">
	    ...
	    <div class="container">
	    	<div class="row row-gap-sm">
	    		<div class="col-xs-12 course-des">
			    	...
			    	<p>The purpose of this HTML is to help determine what default settings are with CSS and to make sure that all possible HTML Elements are included in this HTML</p>
		    	</div>
	    	</div>
	    	<div class="row row-gap-sm">
		       	<div class="col-xs-3">
		       		<h4><span>Refine Results</span><small style="float: right;"><a href="/courses/m-tech/list-of-colleges" class="text-danger">(reset all filters)</a></small></h4>
...
<script type="text/javascript">
	...
	$("input[type='checkbox']").click(function(){
		...
		var newUrl="/courses/m-tech/list of";
		...
		if(redirect==0||urlParam==""){
			if(sortingType!="alpha")
				redirectedUrl="/courses/m-tech/list-of-top-colleges";
			else
				redirectedUrl="/courses/m-tech/list-of-colleges";
